...
from common import enter_range, enter_branch, yellow_text
...
class manhuadb(MangaParser):
    ...
    def __init__(self, config):
        self.config = config
        self.site = config.manhuadb
        self.host = self.site.replace('http://', '')
        self.headers = {
            'Referer': self.host,
    ...
    def search(self, keywords: str):
        response = get_html('https://www.manhuadb.com/search?q=' + keywords, headers=self.headers)
